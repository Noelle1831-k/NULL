...
test_data_path = [
  "/root/autodl-tmp/project/kgragmodel_results/mbpp_layer/layerAIE.npy",
  "/root/autodl-tmp/project/kgragmodel_results/humaneval_layer/layerAIE.npy",
  "/root/autodl-tmp/project/kgragmodel_results/pmc_5000_layer/layerAIE.npy",
  "/root/autodl-tmp/project/kgragmodel_results/menta_layer/layerAIE.npy",
  "/root/autodl-tmp/project/kgragmodel_results/fin_layer/layerAIE.npy",
  "/root/autodl-tmp/project/kgragmodel_results/wikidata_layer/layerAIE.npy",
  "/root/autodl-tmp/project/kgragmodel_results/sciq_layer/layerAIE.npy",
  "/root/autodl-tmp/project/kgragmodel_results/mathematicalproblems_layer/layerAIE.npy",
]

save_path = '/root/autodl-tmp/project/kgrag_llmscan_result'
if not os.path.exists(save_path):
    os.makedirs(save_path)

def load_data_n_train ():
    data_combined = np.load("/root/autodl-tmp/project/kgragmodel_results/pmc_5000_layer/layerAIE.npy")
