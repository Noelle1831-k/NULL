...
test_data_path = [
  "/root/autodl-tmp/project/pmcmodel_results/mbpp_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/pmcmodel_results/humaneval_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/pmcmodel_results/pmc_5000_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/pmcmodel_results/menta_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/pmcmodel_results/fin_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/pmcmodel_results/wikidata_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/pmcmodel_results/sciq_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/pmcmodel_results/mathematicalproblems_hiddenstates/hidden_states.npy",
]

save_path = '/root/autodl-tmp/project/pmc_ldm_result'
if not os.path.exists(save_path):
    os.makedirs(save_path)

def load_data_n_train ():
    data_combined = np.load("/root/autodl-tmp/project/pmcmodel_results/pmc_5000_hiddenstates/hidden_states.npy")
