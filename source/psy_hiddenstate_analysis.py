...
# data_name = 'mbpp'
# path = "/root/autodl-tmp/project/psymodel_results/{}_hiddenstates/".format(data_name)
...
# data_name = 'pmc'
# path = "/root/autodl-tmp/project/psymodel_results/{}_5000_hiddenstates/".format(data_name)
# if not os.path.exists(path):
#     os.makedirs(path)
