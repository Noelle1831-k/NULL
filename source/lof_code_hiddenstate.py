...
test_data_path = [
  "/root/autodl-tmp/project/codemodel_results/mbpp_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/codemodel_results/humaneval_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/codemodel_results/pmc_5000_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/codemodel_results/menta_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/codemodel_results/fin_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/codemodel_results/wikidata_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/codemodel_results/sciq_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/codemodel_results/mathematicalproblems_hiddenstates/hidden_states.npy",
]

save_path = '/root/autodl-tmp/project/code_ldm_result'
if not os.path.exists(save_path):
    os.makedirs(save_path)

def load_data_n_train ():
    path_mbpp = "/root/autodl-tmp/project/codemodel_results/mbpp_hiddenstates/hidden_states.npy"
    path_humaneval = '/root/autodl-tmp/project/codemodel_results/humaneval_hiddenstates/hidden_states.npy'
