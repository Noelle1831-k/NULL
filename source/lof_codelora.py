...
test_data_path = [
  "/root/autodl-tmp/project/codeloramodel_results/mbpp_layer/layerAIE.npy",
  "/root/autodl-tmp/project/codeloramodel_results/humaneval_layer/layerAIE.npy",
  "/root/autodl-tmp/project/codeloramodel_results/pmc_5000_layer/layerAIE.npy",
  "/root/autodl-tmp/project/codeloramodel_results/menta_layer/layerAIE.npy",
  "/root/autodl-tmp/project/codeloramodel_results/fin_layer/layerAIE.npy",
  "/root/autodl-tmp/project/codeloramodel_results/wikidata_layer/layerAIE.npy",
  "/root/autodl-tmp/project/codeloramodel_results/sciq_layer/layerAIE.npy",
  "/root/autodl-tmp/project/codeloramodel_results/mathematicalproblems_layer/layerAIE.npy",
]

save_path = '/root/autodl-tmp/project/codelora_llmscan_result'
if not os.path.exists(save_path):
    os.makedirs(save_path)

def load_data_n_train ():
    path_mbpp = "/root/autodl-tmp/project/codeloramodel_results/mbpp_layer/layerAIE.npy"
    path_humaneval = '/root/autodl-tmp/project/codeloramodel_results/humaneval_layer/layerAIE.npy'
