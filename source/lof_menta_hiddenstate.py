...
test_data_path = [
  "/root/autodl-tmp/project/mentamodel_results/mbpp_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/mentamodel_results/humaneval_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/mentamodel_results/pmc_5000_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/mentamodel_results/menta_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/mentamodel_results/fin_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/mentamodel_results/wikidata_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/mentamodel_results/sciq_hiddenstates/hidden_states.npy",
  "/root/autodl-tmp/project/mentamodel_results/mathematicalproblems_hiddenstates/hidden_states.npy",
]

save_path = '/root/autodl-tmp/project/menta_ldm_result'
if not os.path.exists(save_path):
    os.makedirs(save_path)

def load_data_n_train ():
    data_combined = np.load("/root/autodl-tmp/project/mentamodel_results/menta_hiddenstates/hidden_states.npy")
