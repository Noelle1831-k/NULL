...
test_data_path = [
  "/root/autodl-tmp/project/psymodel_results/mbpp_layer/layerAIE.npy",
  "/root/autodl-tmp/project/psymodel_results/humaneval_layer/layerAIE.npy",
  "/root/autodl-tmp/project/psymodel_results/pmc_5000_layer/layerAIE.npy",
  "/root/autodl-tmp/project/psymodel_results/menta_layer/layerAIE.npy",
  "/root/autodl-tmp/project/psymodel_results/fin_layer/layerAIE.npy",
  "/root/autodl-tmp/project/psymodel_results/wikidata_layer/layerAIE.npy",
  "/root/autodl-tmp/project/psymodel_results/sciq_layer/layerAIE.npy",
  "/root/autodl-tmp/project/psymodel_results/mathematicalproblems_layer/layerAIE.npy",
]

save_path = '/root/autodl-tmp/project/psy_llmscan_result'
if not os.path.exists(save_path):
    os.makedirs(save_path)

def load_data_n_train ():
    data_combined = np.load("/root/autodl-tmp/project/psymodel_results/menta_layer/layerAIE.npy")
