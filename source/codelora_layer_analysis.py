...
data_name = 'mbpp'
path = "/root/autodl-tmp/project/codeloramodel_results/{}_layer/".format(data_name)
...
# data_name = 'pmc'
# path = "/root/autodl-tmp/project/codeloramodel_results/{}_5000_layer/".format(data_name)
# if not os.path.exists(path):
#     os.makedirs(path)
